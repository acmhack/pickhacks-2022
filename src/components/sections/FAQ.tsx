      ...
      <FlexColumn>
        <Title>FAQ</Title>
          ...
          <FAQSegment title="HOW do I apply?" image={trees}>
            <>
              To apply, click <a href="https://dashboard.pickhacks.io" target = "_blank" style={{color: "#FFD51C"}}>here</a> or scroll to the top and click the apply button by April 10th! 
            </>
          </FAQSegment>
      </FlexColumn>
  );
